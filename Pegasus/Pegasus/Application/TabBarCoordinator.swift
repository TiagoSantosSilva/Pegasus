...
final class TabBarCoordinator: Coordinator {
    ...
    func start() {
        ...
        let items: [UITabBarItem] = [.init(title: "Pegasus", image: .TabBar.magazine, selectedImage: .TabBar.magazine),
                                     .init(title: "Settings", image: .TabBar.gear, selectedImage: .TabBar.gear)]
